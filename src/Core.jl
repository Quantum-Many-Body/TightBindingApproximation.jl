...
@inline TBAKind(::Type{Tuple{}}, ::Type{<:Fock{:f}}) = Fermionic(:TBA)
@inline TBAKind(::Type{Tuple{}}, ::Type{<:Fock{:b}}) = Bosonic(:TBA)
@inline TBAKind(::Type{Tuple{}}, ::Type{<:Phonon}) = Phononic()
